...
void draw_boundary(const vector<center_and_angle_t>& multi_object_info, int scaleCol, int scaleRow, Mat& test_img){
    ...
    for (const center_and_angle_t& object_info: multi_object_info){
    ...
    imwrite("annotation.png", test_img);
}
