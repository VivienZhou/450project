...
int main( int argc, char** argv)
{
    ...
    parameter_t para;
    // para.resize_factor = 0.2; [0, 1]
    // para.threshold = 0.8; [0, 1]
    // para.nearby_size = 7; [1, 31] 0 - 15 
    para.resize_factor = strtod(argv[3], NULL);
    para.threshold = strtod(argv[4], NULL);
    para.nearby_size = strtod(argv[5], NULL);
