...
center_and_angle_t resize_and_get_location_and_rotation(const cv::Mat &templ_img, const cv::Mat &test_img) {
    ...
    center_and_angle_t result_center_and_angle = get_location_and_rotation(templ_img, cropped_test_img, resized_center_and_angle.angle - angle_tolerance, resized_center_and_angle.angle + angle_tolerance, 1);
