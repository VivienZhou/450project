...
vector<center_and_angle_t> get_multi_location_and_rotation(const cv::Mat & templ_img, const cv::Mat & test_img, double threshold, double rotation_start = 0, double rotation_end = 360, double rotation_stride = 1);
